  ...
  return (
    <div className="p-4 bg-gray-100 min-h-full pb-24">
      ...
      <button
        ...
        className="fixed bottom-20 right-4 bg-teal-800 hover:bg-teal-900 text-white font-bold py-3 px-4 rounded-full shadow-lg flex items-center transition transform hover:scale-105 z-30"
      >
